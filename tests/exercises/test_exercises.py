...
from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, \
    GetExerciseResponseSchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema, GetExercisesRequest, \
...
class TestExercises:
    ...
    def test_update_exercise(
        ...
        response = exercises_client.update_exercise_api(
            exercise_id=exercise_id, request=request)
    ...
    def test_get_exercises(
        ...
        request = GetExercisesRequest(course_id = function_course.response.course.id)
